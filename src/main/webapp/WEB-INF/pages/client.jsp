...
<t:pageTemplate pageTitle="Clients Page">  
    <form method="POST" action="${pageContext.request.contextPath}/DisplayProducts">
        <br> <br>
        ...
        <a class="w-100 btn btn-primary btn-lg" href="${pageContext.request.contextPath}/DisplayProducts?id=${product.id}" role="button">Find</a>
    </form>
</t:pageTemplate>